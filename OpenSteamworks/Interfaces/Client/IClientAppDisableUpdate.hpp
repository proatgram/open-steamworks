...
osw_abstract_class OSW_UNSAFE_INTERFACE IClientAppDisableUpdate {
public:
	...
	*/
	OSW_UNSAFE_WARNING
	virtual auto SetAppUpdateDisabledSecondsRemaining(osw_unknown_arguments) -> osw_unknown_return = 0;
