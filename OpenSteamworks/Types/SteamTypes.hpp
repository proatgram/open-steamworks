...
#ifndef OSW_OBSOLETE_INTERFACES
	#define OSW_OBSOLETE_INTERFACE STEAMWORKS_DEPRECATE("This interface is obsolete and is not available in the latest builds of Steam. #define OSW_OBSOLETE_INTERFACES to suppress this warning.")
	#define OBSOLETE_INTERFACE STEAMWORKS_DEPRECATE("This interface is obsolete and is not available in the latest builds of Steam. #define OSW_OBSOLETE_INTERFACES to suppress this warning.")
#else
	#define OSW_OBSOLETE_INTERFACE
	#define OBSOLETE_INTERFACE
#endif

#ifndef OSW_OBSOLETE_FUNCTIONS
	#define OSW_OBSOLETE_FUNCTION STEAMWORKS_DEPRECATE("This function is obsolete and is not available in the latest builds of Steam. #define OSW_OBSOLETE_FUNCTIONS to suppress this warning.")
	#define OBSOLETE_FUNCTION STEAMWORKS_DEPRECATE("This function is obsolete and is not available in the latest builds of Steam. #define OSW_OBSOLETE_FUNCTIONS to suppress this warning.")
#else
	#define OSW_OBSOLETE_FUNCTION
	#define OBSOLETE_FUNCTION

#endif

#ifndef OSW_OBSOLETE_CALLBACKS
	#define OSW_OBSOLETE_CALLBACK STEAMWORKS_DEPRECATE("This callback is obsolete and will not be triggered in the latest builds of Steam. #define OSW_OBSOLETE_CALLBACKS to suppress this warning.")
	#define OBSOLETE_CALLBACK STEAMWORKS_DEPRECATE("This callback is obsolete and will not be triggered in the latest builds of Steam. #define OSW_OBSOLETE_CALLBACKS to suppress this warning.")
#else
	#define OSW_OBSOLETE_CALLBACK
	#define OBSOLETE_CALLBACK
#endif

#ifndef OSW_CLIENT_INTERFACES
	#define OSW_UNSAFE_INTERFACE STEAMWORKS_DEPRECATE("IClient interfaces are unversioned and potentially unsafe. Class definition can change between steamclient releases. #define OSW_CLIENT_INTERFACES to suppress this warning.")
	#define UNSAFE_INTERFACE STEAMWORKS_DEPRECATE("IClient interfaces are unversioned and potentially unsafe. Class definition can change between steamclient releases. #define OSW_CLIENT_INTERFACES to suppress this warning.")
#else
	#define OSW_UNSAFE_INTERFACE
	#define UNSAFE_INTERFACE
#endif

#ifndef OSW_UNSAFE_FUNCTIONS
    #define OSW_UNSAFE_WARNING STEAMWORKS_DEPRECATE("The functions argc does not match the previous dump. Use this function at your own risk. Use of mismatched functions can lead to unintended consequences. #define OSW_UNSAFE_FUNCTIONS to supress this warning. ")
    #define UNSAFE_WARNING STEAMWORKS_DEPRECATE("The functions argc does not match the previous dump. Use this function at your own risk. Use of mismatched functions can lead to unintended consequences. #define OSW_UNSAFE_FUNCTIONS to supress this warning. ")
#else
    #define UNSAFE_FUNCTIONS
    #define OSW_UNSAFE_FUNCTIONS
#endif

#ifndef OSW_NOTFOUND_WARNINGS
    #define OSW_NOTFOUND_WARNING STEAMWORKS_DEPRECATE("This function is not found in the new dump. This could be a depricated or removed function, or the dump did not sucessfully find it. Use this function at your own risk. Use of not found functions can lead to unintended consequences. #define OSW_NOTFOUND_WARNINGS to supress this warning.")
    #define NOTFOUND_WARNING STEAMWORKS_DEPRECATE("This function is not found in the new dump. This could be a depricated or removed function, or the dump did not sucessfully find it. Use this function at your own risk. Use of not found functions can lead to unintended consequences. #define OSW_NOTFOUND_WARNINGS to supress this warning.")
#else
    #define OSW_NOTFOUND_WARNINGS
    #define NOTFOUND_WARNINGS
#endif
...
#include "ESteamError.hpp"
#include "ESteamNotify.hpp"
...
using osw_unknown_arguments = void;
...
enum ECallbackType {
	...
	k_iClientUserCallbacks = 1020000,
	...
	k_iClientShortcutsCallbacks = 1130000,
...
#include "MatchMakingKeyValuePair.hpp"
#include "servernetadr.hpp"
#include "gameserveritem.hpp"
#include "FriendGameInfo.hpp"
#include "EVoiceResult.hpp"
#include "ECurrencyCode.hpp"
